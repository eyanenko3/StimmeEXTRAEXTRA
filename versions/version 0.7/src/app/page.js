...
export function renderApp(mountNode) {
  ...
  loopSteps.forEach((stepData, index) => {
    ...
    if (stepData.isFlipCard) {
      ...
      flipFront.innerHTML = `
        <div class="question-front-card">
          <img src="${stepData.imageUrl}" class="question-vertical-img" alt="${stepData.imageAlt}" />
          <h2 class="question-front-text">${stepData.title}</h2>
        </div>
      `;
      ...
      flipBack.innerHTML = `
        <div class="mystery-back-content">
          ...
          <div class="mystery-related-links" style="width: 100%; margin-bottom: 20px;">
            <span class="related-links-label">RELATED TOPICS</span>
            <a href="#" class="related-link-item">
              <span class="link-bullet"></span>
              <span class="link-text">Stimme Editorial Integrity</span>
            ...
            <a href="#" class="related-link-item">
              <span class="link-bullet"></span>
              <span class="link-text">Join the local debate</span>
              <svg class="link-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="9 18 15 12 9 6"></polyline></svg>
            </a>
            <a href="#" class="related-link-item">
              <span class="link-bullet"></span>
              <span class="link-text">Share your own story</span>
              <svg class="link-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="9 18 15 12 9 6"></polyline></svg>
            </a>
          </div>
        </div>
      ...
      relatedLinks.forEach(link => {
        link.addEventListener("click", (e) => {
          e.stopPropagation();
          e.preventDefault();
          showToast(`Opening: ${link.querySelector('.link-text').textContent}`);
        });
      });
        ...
        <div class="feed-card" data-story-id="${story.id}">
          ...
          <div class="feed-content">
            <div class="feed-author-line">
              <span class="feed-author-name">By ${story.author}</span>
              <span class="feed-author-sep">•</span>
              <span class="feed-category-text">${story.category}</span>
            </div>
            <h4 class="feed-headline">${story.title}</h4>
            <p class="feed-summary">${story.summary}</p>
            <div class="feed-meta">
